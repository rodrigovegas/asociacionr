    ...
    <div class="card-body">
        <form action="{{ route('reuniones.store') }}" method="POST">
            ...
            <div class="form-group mt-2">
                ...
                <select name="tipo" class="form-control" required onchange="document.getElementById('canalSelect').style.display = this.value === 'canal' ? 'block' : 'none'">
            ...
            <div class="form-group mt-2">
                ...
                <input type="number" name="multa_monto" class="form-control" step="0.01" value="{{ old('multa_monto') }}">
            </div>

            <div class="form-check mt-2">
                <input type="hidden" name="multa_tercera_edad" value="0">
                <input type="checkbox" name="multa_tercera_edad" value="1" class="form-check-input" id="terceraEdadCheck"
                    {{ old('multa_tercera_edad') ? 'checked' : '' }}>
