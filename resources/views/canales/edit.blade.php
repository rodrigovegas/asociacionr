...
@section('content')
    <div class="container">
        <h3 class="mb-4">✏️ Editar Canal</h3>

        <form action="{{ route('canales.update', $canal) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <textarea name="descripcion" class="form-control" rows="3">{{ old('descripcion', $canal->descripcion) }}</textarea>
            </div>
